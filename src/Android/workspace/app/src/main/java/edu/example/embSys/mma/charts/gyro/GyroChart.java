...
package edu.example.embSys.mma.charts.gyro;
 ...
 * @version 1.0
 */
public class GyroChart extends AbstractDemoChart implements IChart{
  
	/** The name of the lines. */
    String[] titles = new String[] { "Rot X", "Rot Y", "Rot Z"};
    ...
    /** The acc x_buff. */
    List<Double> rotX_buff = new ArrayList<Double>();
    
    /** The acc y_buff. */
    List<Double> rotY_buff = new ArrayList<Double>();
    
    /** The acc z_buff. */
    List<Double> rotZ_buff = new ArrayList<Double>();
  ...
  public String getDesc() {
    return "This chart visualises the rotation velocities around X, Y and Z axis";
  }
  ...
  public Intent execute(Context context) {
    ...
    setChartSettings(renderer, "Rotation around X, Y, Z", "Tick [1]", "Velocity [rad/s]", 0.5, 12.5, -10, 40,
	...
	public void updateChartData() {
		...
		rotX_buff.add(Double.valueOf(CurrentTickData.rotationX));
	    rotY_buff.add(Double.valueOf(CurrentTickData.rotationY));
	    rotZ_buff.add(Double.valueOf(CurrentTickData.rotationZ));
	     ...
	     */
	    // Update y-axis
	    values.set(0,(ChartDataConverter.listToArrayDouble(rotX_buff)));
	    values.set(1,(ChartDataConverter.listToArrayDouble(rotY_buff)));
	    values.set(2,(ChartDataConverter.listToArrayDouble(rotZ_buff)));
	 }
