...
import edu.example.embSys.mma.statemachine.IStateMachine;
import edu.example.embSys.mma.statemachine.StateMachine;
...
public class StateMachineTimerTask extends TimerTask{
    ...
    /**  The format of the timestamp. */
    private SimpleDateFormat timestampFormat = new SimpleDateFormat("hh:mm:ss:SS");
