...
import edu.example.embSys.mma.data.PushToLosant;
...
public class StateMachine implements IStateMachine, IParentStateMachine{
	...
	public void transisionCheck() {
		 ...
		 */
		CurrentTickData.accVecA= Math.sqrt(CurrentTickData.accX*CurrentTickData.accX+
				CurrentTickData.accY*CurrentTickData.accY+
				CurrentTickData.accZ*CurrentTickData.accZ);
